-- Free Burgershot MLO https://www.gta5-mods.com/maps/mlo-burgershot-2023-add-on-sp-fivem
--[[
  ____              _                 _                       
...
Config.BankSystem = 'renewed' -- Supports 'renewed' 'qb' 'nfs'
...
Config.Locations = {
  ClockIn = {
    coords = vector4(-1198.53, -904.75, 14.39, 310.5),
    size = vec3(1.9, 1.9, 1.9),
  },
  BossMenu = vector4(-1197.47, -892.55, 14.04, 216.9),
  Stations = {
    {
      name = 'burgershot_cookmenu',
      coords = vector4(-1195.35, -897.32, 13.8, 260.6),
      label = 'Cook Menu',
    ...
    },
    {
      ...
      coords = vector4(-1196.11, -899.98, 13.8, 173.8),
      label = 'Fryer Menu',
      icon = 'fa-solid fa-fire-burner',
    ...
    },
    {
      ...
      coords = vector4(-1201.79, -895.15, 13.8, 170.5),
      label = 'Prep Station',
    ...
    },
    {
      ...
      coords = vector4(-1191.01, -898.74, 14.24, 320.5),
      label = 'Drink Menu',
  ...
  Registers = {
    vector4(-1191.47, -894.21, 14.04, 216.9),
    vector4(-1193.47, -893.7, 14.04, 216.9),
    vector4(-1195.44, -893.11, 14.04, 216.9),
    vector4(-1197.47, -892.55, 14.04, 216.9),
  },
  Stashes = {
    {
      id = 'bfrontTray1',
      coords = vector4(-1190.93, -894.4, 14.02, 216.9),
      label = 'Tray',
    ...
    {
      id = 'bfrontTray2',
      coords = vector4(-1192.87, -893.86, 14.0, 216.9),
      label = 'Tray',
      icon = 'fa-solid fa-equals',
      jobOnly = false,
      ox = { label = 'Counter', slots = 5, weight = 5000 },
    ...
    {
      id = 'bfrontTray3',
      coords = vector4(-1194.83, -893.38, 14.03, 216.9),
      label = 'Tray',
      icon = 'fa-solid fa-equals',
      jobOnly = false,
    ...
    {
      id = 'bfrontTray4',
      coords = vector4(-1196.8, -892.87, 14.06, 216.9),
      label = 'Tray',
      icon = 'fa-solid fa-equals',
      jobOnly = false,
      ox = { label = 'Tray', slots = 5, weight = 5000 },
    ...
    {
      id = 'bjobFridge',
      coords = vector4(-1202.58, -897.56, 14.16, 216.9),
      label = 'Fridge',
    ...
    {
      id = 'bjobHeater',
      coords = vector4(-1195.05, -896.21, 14.09, 216.9),
      label = 'Heater',
    ...
    {
      id = 'bbackStorage',
      coords = vector4(-1196.7, -901.04, 14.28, 74.5),
      label = 'Storage',
...
Config.BurgershotGaragePed = {
  {
      ...
      BurgershotGaragePedLocation = vector4(-1198.3634033203, -905.18322753906, 12.834527015686, 211.74719238281),
...
Config.GarageVehicles = {
    {
        ...
        icon = 'van-shuttle',
        model = 'burgervan',
        spawn = vector4(-1202.0258789062, -907.41320800781, 13.63232421875, 34.583164215088),
        fuel = 1000.0,
        minGrade = 2,
    },
    {
        ...
        icon = 'car',
        model = 'stalion2',
        spawn = vector4(-1199.0886230469, -911.63262939453, 13.63232421875, 32.271224975586),
        fuel = 500.0,
        minGrade = 4,
    },
    {
        ...
        spawn = vector4(-1195.8092041016, -910.93444824219, 13.632325172424, 59.657718658447),
        fuel = 275.0,
        minGrade = 0,
    },
    {
        ...
        icon = 'motorcycle',
        model = 'burgerbike2',
        spawn = vector4(-1191.751953125, -908.43615722656, 13.632328987122, 123.91223144531),
        fuel = 275.0,
        minGrade = 0,
    },
}
...
Config.BurgershotDeliveryPed = {
  {
    ...
    BurgershotDeliveryPedLocation = vector4(-1200.9089355469, -901.33905029297, 12.886165618896, 212.91464233398),
