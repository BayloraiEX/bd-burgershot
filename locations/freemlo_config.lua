-- Free Burgershot MLO https://www.gta5-mods.com/maps/gtaiv-burgershot-interior-sp-and-fivem
--[[
  ____              _                 _                       
...
Config.Locations = {
  ...
  Stations = {
    ...
    },
    {
      ...
      coords = vector4(-1199.53, -902.13, 13.91, 113.10),
      label = 'Prep Station',
  ...
  Registers = {
    vector4(-1196.16, -891.37, 14.06, 305.83),
    vector4(-1194.59, -893.21, 14.0, 305.16),
    vector4(-1193.22, -895.13, 14.0, 34.0),
  },
  Stashes = {
    {
      id = 'bfrontTray1',
